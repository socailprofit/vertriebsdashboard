...
function setup(){
 ...
 const state={period:'day',referenceDate:'2026-09-08',profile:{role:'sales'},metrics:{old:true}};
 ...
 const context=vm.createContext({state,data,canViewAntony:()=>false,canViewWeeklyReview:()=>false,calendarMonthRange:()=>({start:'2026-09-01',end:'2026-09-30'}),goalPeriodRange:p=>({start:'2026-09-01',end:p==='month'?'2026-09-30':'2026-09-08'}),toPerson:r=>r});
