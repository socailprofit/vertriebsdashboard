...
import {uniqueLeads} from './lead-selection-model.mjs?v=2026-09-10-lead-quality';
...
export function filterOptions(report,key,role='owner') {
 ...
 for(const g of report?.groups||[])for(const lead of uniqueLeads(g)){
