...
- Der Bericht steht als eigener Bereich im Dashboard, ausschließlich in der Antony-Ansicht. Die vollständig eingerichteten Konten `rigone@socialprofit.de` und `info@socialprofit.de` können ihn lesen. Andere Konten bleiben gesperrt. Beide Konten haben die Dashboard-Rolle `manager`; der interaktive KPI-Assistent bleibt für beide freigegeben.
