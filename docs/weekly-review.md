...
- Der Bericht steht als eigener Bereich im Dashboard, ausschließlich in der Antony-Ansicht. Die vollständig eingerichteten Konten `leadership-one@example.invalid` und `leadership-two@example.invalid` können ihn lesen. Andere Konten bleiben gesperrt. Beide Konten haben die Dashboard-Rolle `manager`; der interaktive KPI-Assistent bleibt für beide freigegeben.
...
- 2026-09-07: Handlungsempfehlungen nennen Verantwortlichen, Zeitraum und Erfolgskontrolle; bei unsicherer Grundlage zuerst einen Prüfschritt. Geschütztes manuelles Neugenerieren behält den bisherigen Bericht bis zum erfolgreichen atomaren Austausch.
