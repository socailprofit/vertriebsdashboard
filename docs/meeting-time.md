...
- 2026-09-08, 15:22–15:23 Uhr Berlin: Regulärer Cron mit Version 80 erfolgreich, 388 Zuordnungen unverändert. Eine tatsächliche Datumsänderung wird ohne Nachtrag in der neuen History erfasst. Ein zuvor einmalig am Datenbank-Zeitlimit abgebrochener manueller Snapshot wurde atomar zurückgerollt. Für kurze Transaktionen entfällt künftig JIT-Kompilierung; ausschließlich bei PostgreSQL `57014` wird derselbe zurückgerollte Snapshot einmal erneut versucht, nie bei ungewissem Netzwerkergebnis.
- Zusätzlicher Buchungs-/Gesprächs-Abgleich: 4 der 8 September-Setter Calls haben eine Buchung vor September. Alle 8 bleiben tatsächliche September-Gespräche. 6 passen zu einem Kalendertermin; 2 haben keine nachgewiesene Buchungs-/Meeting-Zuordnung. Keine künstlichen Termine ergänzen und die Gesprächszahl nicht durch die Kalenderbasis teilen. Die UI benennt Kalendertermine und Lead-Ersttermine ausdrücklich; beim zukünftigen Stichtag bleibt die Ist-Showrate auf fällige Termine begrenzt.
