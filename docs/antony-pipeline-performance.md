...
- Die Pipeline verfolgt dieselben gebuchten Leads in zeitlicher Reihenfolge: **Termin → Setter durchgeführt → Closer terminiert → Closer durchgeführt → CC2 vereinbart (optional) → Neukunde**. Die erste dokumentierte Buchung je Lead insgesamt bestimmt Terminlieferant und Startdatum, unabhängig vom gewählten Zeitraum. Mehrere Gespräche desselben Leads vervielfachen diese Gruppe nicht.
