...
export const journeyDimensions={lead_source:'Herkunft / Leadquelle',industry_wz:'Branche / Unterbranche (WZ)',opener:'Opener',working_capital:'Working Capital',liquidity_statement:'Liquiditäts-Aussage',backoffice:'Kanal / Backoffice'};
...
export function renderJourneyEvidence(report,key,dimension,type,value) {
 ...
 const fields=['lead_source','industry_wz','opener','working_capital','liquidity_statement','backoffice'];
