  ...
  const result = await fetch(OPENAI_API_URL, {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        "Die fuenf Gesamt-KPIs sind faellige Setter-Termine, Setter Calls, Closer Calls einschliesslich CC2, durchgefuehrte CC2 (period_bridge.cc2_calls) und erste Neukundenabschluesse. CC2-Vereinbarungen (cc2_agreed) sind keine durchgefuehrten CC2. process trennt tatsaechliche Gespraeche, Setter-Kalendertermine und Vorgangskohorten nach erstem Meeting-Datum. flow.first_qualified sind erste Qualifizierungen, carried_in sind aeltere Vorgaenge mit Setter-Arbeit; Folgegespraeche sind keine neuen Vorgaenge. Die Monatsgruppe folgt ihrem ersten gueltigen Setter-Termin; ihr Fortschritt reicht bis cohort_data_as_of, Aktivitaeten bleiben im gewaehlten Zeitraum. observed_customers sind belegte Neukunden der Gruppe unabhaengig von Zwischenbelegen; new_customers dient nur der vollstaendig verknuepften Kette. Nutze fuer Uebergangsquoten nur dieselbe Vorgangsgruppe, fuer Showrate nur faellige zugeordnete Meetings. Die Monatsprognose darf ausschliesslich die Raten derselben Ersttermin-Monatskohorte und deren noch anstehende Ersttermine (month_planning.first_meetings) verwenden, niemals Arbeitstagstempo oder Closer Calls aus aelteren Vorgangsgruppen. Fehlende Raten ergeben keine Prognose. Verschobene Ersttermine gehoeren in den Monat ihres gueltigen Kalenderdatums; Folgegespraeche verschieben die urspruengliche Kohorte nicht. quality_by_origin bewertet die Herkunft (Opener bzw. LinkedIn-Kanal), unabhaengig vom Gespraechsfuehrer. Closer-Showrate umfasst belegte faellige CC1/CC2-Kalendertermine; bei closer_unclassified>0 ist die Gesamtrate unbekannt. Neukundenquote ist customers/processes derselben Herkunft und Ersttermin-Gruppe. Leadqualitaet und Terminlieferant gehoeren zum jeweiligen Vorgang; unbekannte Zuordnung bleibt unbekannt.",
        ...
        "open_pipeline ist der aktuelle Gesamtbestand zum Datenstand und kein historischer Trend des gewaehlten Zeitraums. Bereits zukuenftig geplante Termine und next_by_month sind keine fehlenden Follow-ups, No-Shows oder aktuelle Performance; addiere sie nicht erneut zum offenen Bestand. Historische Follow-up-Ergebnisse sind keine aktuelle Aufgabenliste. Bei planning_needs_review zuerst die dokumentierte Terminphase klaeren.",
