  ...
  const result = await fetch(OPENAI_API_URL, {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        "process trennt tatsaechliche Gespraeche, Setter-Kalendertermine und Vorgangskohorten nach erstem Meeting-Datum. flow.first_qualified sind erste Qualifizierungen, carried_in sind aeltere Vorgaenge mit Setter-Arbeit; Folgegespraeche sind keine neuen Vorgaenge. Nutze fuer Uebergangsquoten nur dieselbe Vorgangsgruppe, fuer Showrate nur faellige zugeordnete Meetings. Leadqualitaet und Terminlieferant gehoeren zum jeweiligen Vorgang; unbekannte Zuordnung bleibt unbekannt.",
