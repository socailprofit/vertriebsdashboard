...
- Supabase Cron synchronisiert die Daten produktiv viermal pro Stunde; die Bereinigung läuft innerhalb desselben Syncs.
...
- Verbindliches Mapping: `docs/close-mapping.md`, Version `2026-09-03.v2`.
